...
if ( ( isset( $force ) && $force == null ) || ! isset( $force ) ) {
	...
	$wrapper_attributes = [
		'class' => [ 'betterdocs-sidebar betterdocs-full-sidebar-left betterdocs-sidebar-layout-8 betterdocs-background' ],
...
<aside
	...
	<div data-simplebar="init" class="betterdocs-sidebar-content betterdocs-height">
		<?php
			...
			$title_tag = betterdocs()->customizer->defaults->get( 'betterdocs_sidebar_title_tag_layout_8' );
