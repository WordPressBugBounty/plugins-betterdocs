...
class Defaults extends Base {
	...
	public function defaults( $key = '' ) {
		$betterdocs_defaults = [
			...
			'content_header_title_tag_layout7'           => 'h2',
			...
			'archive_column_title_tag_layout7'     => 'h3',
			...
			'betterdocs_social_share_title_tag'            => 'h4',
			...
			'betterdocs_live_search_heading_tag'           => 'h1',
			'betterdocs_live_search_subheading_tag'        => 'p',
			...
			'betterdocs_reactions_title_tag'               => 'h4',
			...
			'betterdocs_faq_section_title_tag'             => 'h2',
			...
			'betterdocs_faq_group_title_tag'               => 'h3',
