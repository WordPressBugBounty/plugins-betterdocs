...
use WPDeveloper\BetterDocs\Dependencies\DI\Compiler\Compiler;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\AnnotationBasedAutowiring;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\DefinitionArray;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\DefinitionFile;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\DefinitionSource;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\NoAutowiring;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\ReflectionBasedAutowiring;
use WPDeveloper\BetterDocs\Dependencies\DI\Definition\Source\SourceCache;
...
class ContainerBuilder
{
    ...
    /**
     * If PHP-WPDeveloper\BetterDocs\Dependencies\DI is wrapped in another container, this references the wrapper.
     ...
     */
    public function __construct(string $containerClass = 'WPDeveloper\BetterDocs\Dependencies\DI\Container')
    {
    ...
    public function build()
    {
        ...
        if ($this->sourceCache) {
            if (!SourceCache::isSupported()) {
                throw new \Exception('APCu is not enabled, PHP-WPDeveloper\BetterDocs\Dependencies\DI cannot use it as a cache');
            }
     ...
     * set this so that PHP-WPDeveloper\BetterDocs\Dependencies\DI will use the wrapper rather than itself for building objects.
     *
     * @return $this
     */
     ...
     *   PHP-WPDeveloper\BetterDocs\Dependencies\DI knows about them and compiles them
