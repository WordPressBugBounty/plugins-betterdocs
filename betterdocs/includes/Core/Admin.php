         ...
         */
            ...
            $notices->add(
                ...
                array(
                    ...
                    $february_campaign_message = '<div class="betterdocs-february-notice-body"><p style="margin-top: 0; margin-bottom: 0;">Build <strong>AI-Powered Knowledge Base</strong> & FAQs to empower support and improve user experience – now <strong>flat 20% OFF!</strong> 🎁</p></div>';
                    $_february_campaign_notice = array(
            'thumbnail' => $this->assets->icon( 'betterdocs-logo.svg', true ),
            'html' => $february_campaign_message,
            'links' => array(
                'support' => array(
                    'link' => 'https://betterdocs.co/feb2026-admin-notice',
                    'attributes' => array(
                        'target' => '_blank',
                        'class' => 'offer-button'
                    ),
                ...
                'maybe_later' => array(
                    ...
                    $notices->add(
            'february-campaign-26',
            $_february_campaign_notice,
            array(
                'start' => $notices->time(),
                'recurrence' => false,
                'dismissible' => true,
                'refresh' => BETTERDOCS_VERSION,
                'expire' => strtotime( '11:59:59pm March 8, 2026' ),
